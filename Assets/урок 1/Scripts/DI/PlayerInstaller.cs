...
namespace DI
{
    ...
    {
        [FormerlySerializedAs("_playerMovement")] [SerializeField] private PlayerMovementt playerMovementt;
        ...
        {
            Container.Bind<PlayerMovementt>().FromInstance(playerMovementt).AsSingle().NonLazy();
